...
{
	static void write_uint32(java.io.BufferedOutputStream f, int v)
	{
	...
	static void write_uint16(java.io.BufferedOutputStream f, int v)
	{
	...
	public static void wavwriter_writeheaders(java.io.BufferedOutputStream f, int datasize, int numchannels, int samplerate, int bytespersample, int bitspersample)
	{
